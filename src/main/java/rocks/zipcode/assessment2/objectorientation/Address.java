...
public class Address {
    ...
    public boolean equals(Object o) {
        ...
        return ((this.addressLine1.equals((address.getAddressLine1()))) &&
                (this.addressLine2.equals((address.getAddressLine2()))) &&
    ...
    public String toString(){
        return "Address{addressLine1='" + this.addressLine1 + "', addressLine2='" + addressLine2 +
